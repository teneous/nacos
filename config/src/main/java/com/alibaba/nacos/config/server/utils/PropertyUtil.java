...
public class PropertyUtil implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    /**
     * get storage db engine name
     */
    private static String storageEngineName = EnvUtil.getStorageEngineName();
    ...
    public static void setExternalStorageName(String externalStorage) {
        storageEngineName = externalStorage;
    }
    ...
    private void loadSetting() {
        try {
            ...
            setUseExternalDB(StringUtils.isNotBlank(getString("spring.datasource.platform", "")));
            if (isUseExternalDB()) {
                setExternalStorageName(getString("spring.datasource.platform", ""));
            }
